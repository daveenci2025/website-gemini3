            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-32 w-full max-w-5xl px-4">
               ...
               <ScrollReveal delay={200} className="flex flex-col items-center group">
                  <div className="w-full max-w-sm aspect-square relative mb-6">
                     <img 
                        src="/images/Anton%20Osipov%20-%20AI%20Impelmention%20Engeener.png" 
                        onError={handleImageError}
                        alt="Anton Osipov" 
                        className="w-full h-full object-cover object-top filter grayscale group-hover:grayscale-0 transition-all duration-700 rounded-sm shadow-sm" 
                     />
                  </div>
                  <div className="text-center">
                     <h3 className="font-serif text-3xl text-ink mb-2">Anton Osipov</h3>
                     <p className="font-mono text-xs font-bold text-accent uppercase tracking-widest">Co-Founder & AI Implementation Engineer</p>
                  </div>
               </ScrollReveal>
